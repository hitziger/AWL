% processes epoched spike dataset in two ways:
%
...
param.verbose = true;  % TODO: deactivate, leave for now (problems when not active, some interference with align!!)
